...
if len(sys.argv[:])!=2:
    print ("python cellPropertyFromMask.py cell_mask_in \n")
    print("cells.tsv file be generated\n")
    sys.exit()
    
cell_mask_file = sys.argv[1]
...
celltable = pd.DataFrame(skimage.measure.regionprops_table(cell_mask, properties=properties))
